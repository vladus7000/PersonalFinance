...
/// The ordered list of onboarding steps. Currently steps 1, 2, 3 and 4 of
/// §3.3 doc.md (E2.T3, E3.T3) — later tasks (cushion E7.T2, investments
...
List<OnboardingStepDefinition> onboardingSteps(Ref ref) => const [
  ...
  OnboardingStepDefinition(id: OnboardingStepIds.income, isRequired: true),
  OnboardingStepDefinition(id: OnboardingStepIds.incomeCalculation, isRequired: true),
